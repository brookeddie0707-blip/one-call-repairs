  ...
  return (
    <>
      <Seo
        ...
        description="All 18 services: DStv installations & repairs, satellite dishes, E48-32 fixes, OpenView, CCTV, painting, garage doors, gate motors, aircon, waterproofing, roofing, TV mounting, WiFi extensions, Extra View & Triple View & more across Gauteng."
      />
      <PageHeader
        eyebrow="Our services"
        title="Eighteen trades."
        highlight="One team."
